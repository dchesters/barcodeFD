...
perl ~/scripted_analyses/tingting/scripts/process_bayestraits_input.pl classed_trait_table.20201231 OTU_assignments phylogeny_species bee_traits.bayestraits_input
